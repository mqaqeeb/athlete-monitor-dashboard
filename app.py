...
if page == "Dashboard":
    ...
    with col1:
        ...
        st.caption("Category: Para Athlete")
    ...
    hr_series = (
        sessions_df["Avg_Heart_Rate"].tail(30)
        if sessions_df is not None
        else np.random.normal(avg_hr, 4, 30)
    )
    ...
    with st.form("predict"):
        ...
        with left:
            ...
            avg_hr_input = st.number_input("Average Heart Rate", 120.0)
    ...
    if submit and model:
        row = [
            duration, distance, avg_hr_input,
            hrv, spo2, skin_temp,
            sweat, pre_w, post_w
        ]
